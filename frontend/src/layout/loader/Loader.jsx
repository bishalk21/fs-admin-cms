...
const Loader = () => {
  return (
    <div className="main-container w-full h-screen flex justify-center items-center">
      <div className="loader-container rounded relative">
        <div className="loader-circle rounded-full bg-indigo-200 w-[190px] h-[190px] relative flex justify-center items-center mx-auto animate-spin">
          <svg
            className="loader-svg absolute top-[2px] right-0"
            width={76}
            height={97}
            viewBox="0 0 76 97"
            fill="none"
          ...
          <div className="inner-circle rounded-full bg-white w-[150px] h-[150px]" />
        </div>
        <p className="loading-text absolute mx-auto inset-x-0 my-auto inset-y-[80px] text-base font-medium text-gray-800 text-center">
          Loading ...
        </p>
      </div>
    </div>
